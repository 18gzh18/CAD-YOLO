...
from utils.general import colorstr, increment_path, make_divisible, non_max_suppression, save_one_box, \
    scale_coords, xyxy2xywh, check_suffix
from utils.plots import Annotator, colors
from utils.torch_utils import time_sync
from models.conv.dynamic_conv import *
from models.SwinTransformer import SwinTransformerLayer

# 激活函数
from utils.activations import *
# hetconv卷积
from models.HetConv import *
    ...
    def __init__(self, inp, oup, hidden_dim, kernel_size, stride, use_se, use_hs):
        ...
        if inp == hidden_dim:
            self.conv = nn.Sequential(
                ...
                nn.SiLU() if use_hs else nn.ReLU(),
                # Squeeze-and-Excite
